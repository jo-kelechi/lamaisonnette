  ...
  <body>
        ...
        <ul class="row">
          ...
          <li class="col-lg-4">
            <div class="elementInfo">
              ...
              <h3>Focus</h3>
              <p>Providing a unique, high-quality early learning experience for children between the age of 3months to 5 years old...</p>
            </div>
          </li>
          <li class="col-lg-4">
            <div class="elementInfo">
              ...
              <h3>Our Belief</h3>
              <p>We believe that every child is a gem; unique, with limitless potential, ready to shine. Each gem is special.....</p>
            </div>
          </li>
        </ul>
      </div>
    ...
    <div class="about-wrap">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="aboutImg"><img src="images/about-sec-img.png" alt=""></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="classes class-wrap">
      <div class="container">
        <div class="section-header">
          <div class="title">
            <h1>Our <span>Curriculum</span></h1>
          </div>
          <p>We run a parallel curriculum; a French language programme and the EYFS curriculum which is British based for our preschoolers.</p>
        </div>
    ...
    <div class="project-wrap">
      ...
      <div class="galleryWrp">
        ...
        <div class="readmore"><a href="/gallery.php">View All <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i></a></div>
      </div>
    </div>
    <!--Project End--> 
